...
\solution
\lstinputlisting[language=Python]{codes/3.1.py}
\begin{figure}[!ht]
\begin{center}
...
\lstinputlisting[language=Python]{codes/3.2.py}
\begin{figure}[!ht]
\begin{center}
...
\solution
\lstinputlisting[language=C]{codes/3.3.c}
\lstinputlisting[language=Python]{codes/3.3.py}
\begin{figure}[!ht]
\begin{center}
...
\lstinputlisting[language=Python]{codes/4.6.py}
\begin{figure}[!ht]
\centering
...
\lstinputlisting[language=Python]{codes/5.3.py}
\begin{figure}[ht]
\centering
...
\solution
\lstinputlisting[language=Python]{codes/5.6.py}
\item 
...
\ref{fig:hn}. 
%
\lstinputlisting[language=Python]{codes/5.7.py}
\begin{figure}[!ht]
\centering
...
\ref{fig:xnyn}. 
%
\lstinputlisting[language=Python]{codes/5.8.py}
\begin{figure}[!ht]
\centering

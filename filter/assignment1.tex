...
\solution
\begin{lstlisting}
    wget https://github.com/Galahad7377/EE3900/blob/main/Assignment_1/codes/3.1.py
\end{lstlisting}
\begin{figure}[!ht]
\begin{center}
...
\solution
\begin{lstlisting}
    wget https://github.com/Galahad7377/EE3900/blob/main/Assignment_1/codes/3.3.c
\end{lstlisting}
\begin{lstlisting}
    wget https://github.com/Galahad7377/EE3900/blob/main/Assignment_1/codes/3.3.py
\end{lstlisting}
\begin{figure}[!ht]
\begin{center}
...
\begin{lstlisting}
    wget https://github.com/Galahad7377/EE3900/blob/main/Assignment_1/codes/4.6.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
\includegraphics[width=\columnwidth]{figs/4.6.png}
\caption{$\abs{H\brak{e^{\j\omega}}}$}
\label{fig:dtft}
\end{figure}
$\abs{H\brak{e^{\j\omega}}}$ is periodic with a period of 2$\pi$.
\\
...
\[= \frac{1}{2\pi}\int_{-\pi}^{\pi} {\sum_{k=-\infty}^{\infty} h(k) e^{(n-k)\j\omega}} d\omega\\\]
\[= {\sum_{k=-\infty}^{\infty} h(k) \delta(n-k)}\]
\[= h(n)\]
\end{enumerate}
...
\polylongdiv{X^2+1}{\frac{1}{2}X+1}
...
\begin{lstlisting}
    wget https://github.com/Galahad7377/EE3900/blob/main/Assignment_1/codes/5.3.py
\end{lstlisting}
\begin{figure}[ht]
\centering
...
\solution
\begin{lstlisting}
    wget https://github.com/Galahad7377/EE3900/blob/main/Assignment_1/codes/5.6.py
\end{lstlisting}
\item 
...
%
\begin{lstlisting}
    wget https://github.com/Galahad7377/EE3900/blob/main/Assignment_1/codes/5.7.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
    wget https://github.com/Galahad7377/EE3900/blob/main/Assignment_1/codes/5.8.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
